...
The application was developed and deployed at France Travail in spring 2022 (TradEmploi), and at SNCF in 2024 to assist the 2 million foreign travelers (TradSNCF). It became available to the entire [inclusion network](https://inclusion.gouv.fr) in 2024, and [Pro Connect](https://www.proconnect.gouv.fr) in 2025.
...
- User account: SSO France Travail, SNCF, [Pro Connect]([https://inclusion.gouv.fr](https://www.proconnect.gouv.fr)), Firebase Auth (login/password or certificate).
